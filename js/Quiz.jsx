        ...
        reader.onload = (event) => {
            ...
            img.onload = () => {
                ...
                if(compressedBase64.length > 800000) {
                    return showAlert("❌ 圖片解析度過高，壓縮後仍過大，請裁切或選擇更小的圖片。");
                }
...
function FastQASection({ user, showAlert, targetQaId, onClose }) {
    ...
    return (
        <div className={`border-2 border-pink-400 bg-pink-50 dark:bg-pink-900/20 p-4 shadow-md relative no-round w-full ${targetQaId ? 'h-[100dvh] overflow-y-auto custom-scrollbar m-0' : 'mb-8 shrink-0'}`}>
